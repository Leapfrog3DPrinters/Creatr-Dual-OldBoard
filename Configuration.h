...
#define STRING_VERSION_CONFIG_H "Creatr SW V1.10" //Personal revision number for changes to THIS file.
...
#define EXTR2_X_OFFSET 33.0+0.00 //
...
#define DEFAULT_MAX_ACCELERATION      {1000,1000,500,10000, 10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
